...
import { MatSnackBar } from '@angular/material';//Para criação do alerta
...
export class CadastrarPfComponent implements OnInit {
  ...
  ngOnInit() {
    this.gerarForm();//Responsável por criar o arquivo HTML no mapeamento@!
  }

  gerarForm() {
  	this.form = this.fb.group({ //Validadores do angular
